    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("role", models.CharField(choices=[("analyst", "Analyst"), ("manager", "Manager")], default="analyst", max_length=20)),
            ...
            options={
                "ordering": ["username"],
                "indexes": [models.Index(fields=["organization", "role"], name="users_user_organiz_63063b_idx")],
            },
        )
    ]
